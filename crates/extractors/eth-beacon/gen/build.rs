fn main() -> Result<(), Box<dyn std::error::Error>> {
    #[cfg(gen_schema_manifest)]
    {
        ...
        let manifest_schema = schemars::schema_for!(eth_beacon_datasets::Manifest);
        ...
        println!(
            "cargo:warning=Generated ETH Beacon dataset manifest schema file: {}",
    ...
    #[cfg(gen_schema_tables)]
    {
        ...
        let markdown = rt.block_on(async {
            datasets_raw::schema::to_markdown(eth_beacon_datasets::all_tables(
        ...
        println!(
            "cargo:warning=Generated ETH Beacon table schema markdown file: {}",
            tables_schema_path
        );
    }
